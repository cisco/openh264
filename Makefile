...
CODEC_UNITTEST_LDFLAGS = -L. $(call LINK_LIB,gtest) $(call LINK_LIB,decoder) $(call LINK_LIB,crypto) $(call LINK_LIB,encoder) $(call LINK_LIB,processing) $(call LINK_LIB,common)
